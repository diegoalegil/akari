# Prompts útiles para Akari (灯)

268 prompts en español para integrar en la app de aprender japonés — como sugerencias del **Sensei (Explícame)**, tips de estudio, ideas de búsqueda o preguntas contextuales. Muchos aprovechan el contexto de tarjeta que ya inyecta la app (*esta palabra*, *este kanji*, *esta lectura*, *esta frase*); otros son de método y motivación, no atados a una tarjeta concreta.

> Generados a partir de datos y necesidades reales de aprendizaje; no contienen contenido japonés inventado (son preguntas/peticiones, no afirmaciones de lecturas o significados).

---

## 1. Vocabulario: significado, matiz y connotación  ·  (18)
...
## 2. Vocabulario: uso, registro y colocaciones (cuándo sí / cuándo no)  ·  (16)
...
## 3. Kanji: lecturas on/kun, componentes/radicales, orden de trazos  ·  (18)
...
## 4. Kana e iniciación: hiragana, katakana, dakuten, combinaciones, romaji  ·  (18)
...
## 5. Acento tonal y pronunciación: contorno, mora, sonidos difíciles  ·  (18)
...
## 6. Gramática: estructura de la frase, orden, formas y construcciones  ·  (18)
...
## 7. Partículas: は/が, を, に/で, へ, と, から/まで, の, etc. (preguntas sobre su función)  ·  (18)
...
## 8. Verbos y adjetivos: grupos, conjugación, te-form, formas casual/cortés, transitivo/intransitivo  ·  (18)
...
## 9. Cortesía, keigo y registro social: formal vs casual, cuándo usar cada uno  ·  (18)
...
## 10. Palabras y formas parecidas: diferencias y cuándo elegir cada una  ·  (18)
...
## 11. Frases y producción: pedir ejemplos, variar, reformular, construir oraciones propias  ·  (18)
...
## 12. Errores típicos de hispanohablantes aprendiendo japonés  ·  (18)
...
## 13. Mnemotecnia, memoria y repaso espaciado: cómo fijar esta tarjeta  ·  (18)
...
## 14. Cultura, contexto real y pragmática: cómo suena, cuándo se dice, matices sociales  ·  (18)
...
## 15. Método de estudio y uso de Akari: rachas, repaso, kana/kanji/acento, motivación  ·  (18)
